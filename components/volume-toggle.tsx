...
import { volumeMuteAtom } from "@/lib/atom"

export function VolumeToggle() {
  const [volumeMute, setVolumeMute] = useAtom(volumeMuteAtom)
    ...
    <div className="mx-auto">
      {volumeMute ? (
        <svg
          ...
          viewBox="0 0 20 20"
          fill="currentColor"
          className="size-5 fill-gray-500 transition hover:cursor-pointer hover:fill-gray-400"
